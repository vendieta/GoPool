...
import { View, Text, StyleSheet, ScrollView, Alert, Image, Dimensions, Platform, TouchableOpacity, Modal, ActivityIndicator, useColorScheme } from "react-native";
...
export default function CreateRoutesDriver() {
  ...
  const theme = useMemo(() => ({
    ...
    background2: isDark ? "#1E1E1E" : "#F9F9F9",
