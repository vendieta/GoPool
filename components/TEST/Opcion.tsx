...
const OptionCard = ({
  ...
  <View
    style={[
      ...
      { backgroundColor: isLightTheme ? '#fafafa' : '#2a2a2a' },
    ]}
  >
    <Link href={link} asChild>
      <TouchableOpacity style={styles.optionCard}>
...
export default function Opcion({ element, element1 }: any) {
  ...
  return (
    <View style={styles.mainContainer}>
      <OptionCard {...element} isLightTheme={isLightTheme} actionText="Ver viajes" />
      ...
      <OptionCard {...element1} isLightTheme={isLightTheme} actionText="Ofrecer viaje" />
    </View>
  );
}
